...
from grammarlab.core.common import NonTerminal, Symbol, SymbolType, Terminal
...
class ExtendedSymbol(Symbol):
    ...
    If you want to used color you need to enable it in :mod:`grammarlab.core.config`.
