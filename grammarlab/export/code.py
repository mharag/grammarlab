...
if __name__ == "__main__":
    App(G).run()
""")
        representation.imports.add("from grammarlab.core.cli import App")
...
""")
        representation.imports = {
            f"from grammarlab.grammars import {grammar_type}"
        }
        return representation
    ...
    def ScatteredContextGrammar(self, grammar, grammar_name="G"):
        ...
        .. code-block:: python
            ...
            from grammarlab.grammars import SCG
    ...
    def PCGrammarSystem(self, grammar, grammar_name="G"):
        ...
        .. code-block:: python
            ...
            from grammarlab.grammars import PC
            from grammarlab.grammars import CF
...
""")
        representation.imports = imports | {
            f"from grammarlab.grammars.grammars import {grammar_type}"
        }
        return representation
